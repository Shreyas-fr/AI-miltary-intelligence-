...
scenarios = [
    ("Iraq", "Middle East & North Africa", "Explosives", "Private Citizens & Property", "Unknown", 2017, 1, 0, 5.0, 15.0),
    ("Afghanistan", "South Asia", "Firearms", "Military", "Taliban", 2017, 1, 0, 20.0, 5.0),
    ("United States", "North America", "Incendiary", "Business", "Unknown", 2017, 1, 0, 0.0, 0.0),
    ("India", "South Asia", "Melee", "Police", "Maoists", 2017, 1, 0, 1.0, 2.0),
    ("Somalia", "Sub-Saharan Africa", "Explosives", "Government (General)", "Al-Shabaab", 2017, 1, 1, 30.0, 50.0),
]

features = ["country_txt", "region_txt", "weaptype1_txt", "targtype1_txt", "gname", "iyear", "success", "suicide", "nkill", "nwound"]
